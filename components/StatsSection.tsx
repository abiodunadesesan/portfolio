...
export default function StatsSection() {
  return (
    <AnimatedSection
      id="stats"
      className="binary-matrix relative z-20 scroll-mt-24 border-t border-zinc-200/60 bg-white px-6 py-20 dark:border-white/10 dark:bg-[#0a0a10] md:scroll-mt-28 md:px-12 md:py-24"
